...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'eve_db_ramtyperequirement', ['type_id', 'activity_type_id', 'required_type_id'])

        # Deleting model 'InvBlueprintType'
        db.delete_table(u'eve_db_invblueprinttype')

        # Deleting model 'RamTypeRequirement'
        db.delete_table(u'eve_db_ramtyperequirement')

        # Deleting model 'RamAssemblyLine'
        db.delete_table(u'eve_db_ramassemblyline')

        # Adding field 'RamAssemblyLineTypeDetailPerGroup.cost_multiplier'
        db.add_column(u'eve_db_ramassemblylinetypedetailpergroup', 'cost_multiplier',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RamAssemblyLineType.base_cost_multiplier'
        db.add_column(u'eve_db_ramassemblylinetype', 'base_cost_multiplier',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'RamAssemblyLineType.description'
        db.alter_column(u'eve_db_ramassemblylinetype', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DgmAttributeCategory.description'
        db.alter_column(u'eve_db_dgmattributecategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DgmAttributeCategory.name'
        db.alter_column(u'eve_db_dgmattributecategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'RamAssemblyLineTypeDetailPerCategory.cost_multiplier'
        db.add_column(u'eve_db_ramassemblylinetypedetailpercategory', 'cost_multiplier',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'eve_db_invblueprinttype', (
            ...
            ('production_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('parent_blueprint_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_blueprint_type_set', null=True, to=orm['eve_db.InvType'], blank=True)),
        ...
        db.create_unique(u'eve_db_ramtyperequirement', ['type_id', 'activity_type_id', 'required_type_id'])

        # Adding model 'RamAssemblyLine'
        db.create_table(u'eve_db_ramassemblyline', (
            ...
            ('restriction_mask', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('next_free_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        # Deleting field 'RamAssemblyLineTypeDetailPerGroup.cost_multiplier'
        db.delete_column(u'eve_db_ramassemblylinetypedetailpergroup', 'cost_multiplier')

        # Deleting field 'RamAssemblyLineType.base_cost_multiplier'
        db.delete_column(u'eve_db_ramassemblylinetype', 'base_cost_multiplier')


        # Changing field 'RamAssemblyLineType.description'
        db.alter_column(u'eve_db_ramassemblylinetype', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DgmAttributeCategory.description'
        db.alter_column(u'eve_db_dgmattributecategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DgmAttributeCategory.name'
        db.alter_column(u'eve_db_dgmattributecategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Deleting field 'RamAssemblyLineTypeDetailPerCategory.cost_multiplier'
        db.delete_column(u'eve_db_ramassemblylinetypedetailpercategory', 'cost_multiplier')
    ...
    models = {
        ...
        'eve_db.planetschematicstypemap': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_input': ('django.db.models.fields.BooleanField', [], {}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'schematic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.PlanetSchematic']"}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eve_db.InvType']"})
        },
        ...
        'eve_db.ramassemblylinetype': {
            ...
            'base_cost_multiplier': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'eve_db.ramassemblylinetypedetailpercategory': {
            ...
            'cost_multiplier': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
