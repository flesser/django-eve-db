...
class PlanetSchematic(caching.base.CachingMixin, models.Model):
    """
...
class PlanetSchematicsPinMap(caching.base.CachingMixin, models.Model):
    """
...
class PlanetSchematicsTypeMap(caching.base.CachingMixin, models.Model):
    """
